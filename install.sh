...
install_software() {
  sudo pacman -S blueman brightnessctl btop firefox github-cli grim hyprcursor hypridle hyprpaper kitty nautilus neovim obs-studio pavucontrol polkit-kde-agent slurp swaync tlp tmux wofi unzip waybar wireplumber wl-clipboard xdg-desktop-portal-hyprland
  #sudo pacman -R dolphin htop
  ...
  yay -S clipse hyprlock-git hyprpicker ttf-firacode-nerd vesktop-bin wlogout wlrobs-hg
